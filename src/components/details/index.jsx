  ...
  return (
    <div>
      <section className="flex gap-2 max-sm:flex-col relative overflow-hidden rounded-md">
        <div className="animate-pulse bg-muted rounded-lg aspect-square min-h-72" />
...
export function Details({ id, title, image, description, tags, error }) {
  if (error) {
  ...
  return (
    <div>
      <section className="flex max-sm:flex-col relative overflow-hidden rounded-md">
        ...
        />
        <div
          className="z-10 min-h-72 aspect-square bg-cover bg-no-repeat"
          style={{ backgroundImage: `url(${image})` }}
        />
        ...
        <header className="flex flex-col justify-between gap-2 z-10 p-4">
          <div className="flex flex-col gap-4">
            <h1>
              ...
              <sup className="text-md text-muted-foreground">#{id}</sup>
            </h1>
